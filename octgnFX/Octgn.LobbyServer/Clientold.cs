...
{
    public class Clientold : SkySocketOld, IEqualityComparer<Clientold>
    {
        /// <summary>
        ...
        public Clientold(TcpClient client, int id)
            : base(client)
        {
            Id = id;
            LoggedIn = false;
        ...
        public bool Equals(Clientold client)
        {
            return (Id == client.Id);
        }
        ...
        private void AcceptFriend(SocketMessage sm)
        {
                ...
                if (accept)
                {
                    ...
                    //Clientold c = Server.GetOnlineClientByUid(requestee.Uid);
                    //if (c != null)
                    //{
                ...
                //Clientold rclient = Server.GetOnlineClientByUid(requestee.Uid);
                //if (rclient != null)
        ...
        private void AddFriend(SocketMessage sm)
        {
                ...
                if (!Verify.IsEmail(email))
                    return;
                email = email.ToLower();
                //Clientold c = Server.GetOnlineClientByEmail(email);
        ...
        public bool Equals(Clientold x, Clientold y)
        {
            return (x.Id == y.Id);
        }

        public int GetHashCode(Clientold obj)
        {
            return Id;
        }
    }
