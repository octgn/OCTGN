namespace Octgn.ReleasePusher.Tasking.Tasks
{
    ...
    public class IncrementVersionNumbersInFiles : ITask
    {
        ...
        public virtual string[] GetUpdateFiles(ITaskContext context)
        {
            ...
            list.Add(this.CreateUpdateString(context, "octgnFX\\Octgn.Online.MatchmakingService\\Properties\\AssemblyInfo.cs"));
            ...
            list.Add(this.CreateUpdateString(context, "octgnFX\\Octide\\Properties\\AssemblyInfo.cs"));
