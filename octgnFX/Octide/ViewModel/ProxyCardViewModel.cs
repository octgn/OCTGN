...
namespace Octide.ViewModel
{
    public class ProxyCardViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<ProxyOverlayItemModel> _activeImageLayers;
        ...
        public AltItemModel Card
        {
            ...
            set
            {
               // if (_card == value) return;
                ...
                if (value != null)
                {
                    if (_card._tempImageCard == null) return;
        ...
        public ObservableCollection<ProxyOverlayItemModel> ActiveLayers
        {
            get
            {
                return _activeImageLayers;
            }
            set
            {
                if (_activeImageLayers == value) return;
                _activeImageLayers = value;
