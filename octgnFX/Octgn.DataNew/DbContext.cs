...
{
    public class DbContext : IDbContext, IDbContextCaching
    {
        private readonly static ILog Log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        internal static IDbContext Context { get; private set; }
        ...
        public static IDbContext SetContext(IDbContext context) {
