...
namespace Octgn.Play.Gui.Adorners
{
    internal class CardDragAdorner : Adorner, IDisposable
    {
            ...
            : base(Program.PlayWindow.Content as UIElement)
        {
            ...
            bim.UriSource = new Uri(Program.GameEngine.Definition.CardDefinition.Front);
            bim.EndInit();
        ...
        public void SetState(double dx, double dy, bool canDrop, Size size, bool faceUp, bool isInverted)
        {
            ...
            {
                _mouseAdjustment +=
                    new Vector(_mouseOffset.X*(size.Width - _child.Width)/Program.GameEngine.Definition.CardDefinition.Width,
