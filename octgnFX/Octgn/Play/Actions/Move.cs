        ...
        public override void Do()
        {
...

            {
                ...
                if (IsScriptMove)
                {
                    ...
                    Program.GameEngine.EventProxy.OnScriptedMoveCards_3_1_0_2(Who, cards, oldGroups, tos, oldIndexes, indexes, oldX, oldY, x, y, oldHighlights, oldMarkers, oldFaceUps);
                }
                else
                {
                    ...
                    Program.GameEngine.EventProxy.OnMoveCards_3_1_0_2(Who, cards, oldGroups, tos, oldIndexes, indexes, oldX, oldY, x, y, oldHighlights, oldMarkers, oldFaceUps);
                }
            }
