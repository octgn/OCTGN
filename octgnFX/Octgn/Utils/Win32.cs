...
namespace Octgn.Utils
{
    public static class Win32
    {
        ...
        public const Int32 WmSyscommand = 0x112;
        ...
        [DllImport("user32.dll", CharSet = CharSet.Auto)]
        private static extern int SendMessage(IntPtr hWnd, uint msg, IntPtr windowParam, IntPtr lparam);
        ...
        {
            SendMessage(new WindowInteropHelper(window).Handle, WmSyscommand, (IntPtr)(61440 + direction), IntPtr.Zero);
        }
