...
namespace Octgn
{
    ...
    internal class GroupVisibilityConverter : EnumConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                case "none": return GroupVisibility.Nobody;
                case "me": return GroupVisibility.Owner;
                case "all": return GroupVisibility.Everybody;
                case "undefined": return GroupVisibility.Undefined;
