...
{
    public class ThreadSafeDictionary<TKey, TValue> : IDictionary<TKey, TValue> , ICollection , IDisposable
    {
        ...
        public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator()
        {
            ...
            try
            {
                Dictionary<TKey, TValue> temp = _dict.ToDictionary(kvi => kvi.Key , kvi => kvi.Value);
