...
namespace Octgn
{
    ...
    public class GameEngine : INotifyPropertyChanged, IGameEngine
    {
        ...
        private Octgn.Play.IPlayPlayer _turnPlayer;
        ...
        public Octgn.Play.IPlayPlayer TurnPlayer
        {
        ...
        public void LoadDeck(IDeck deck)
        {
            ...
            Octgn.PlayTable.Program.Client.Rpc.LoadDeck(ids, keys, groups);
        ...
        public void AddRecentCard(DataNew.Entities.Card card)
        {
        ...
        public void AddRecentMarker(DataNew.Entities.Marker marker)
        {
        ...
        public DataNew.Entities.Marker GetMarkerModel(Guid id)
        {
            ...
            {
                Octgn.PlayTable.Program.Trace.TraceEvent(TraceEventType.Verbose, EventIds.NonGame,
