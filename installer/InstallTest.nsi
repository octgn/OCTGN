...
Name "OCTGN 3.1.12.58"
OutFile "OCTGN-Test-Setup-3.1.12.58.exe"
ShowInstDetails show
LoadLanguageFile "${NSISDIR}\Contrib\Language files\English.nlf"

; Version Information
VIProductVersion "3.1.12.58"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "3.1.12.58"
...
Section "Uninstall" 
  ; Has to be removed first for some r00son
