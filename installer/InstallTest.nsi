...
Name "OCTGN 3.0.1.32"
OutFile "OCTGN-Test-Setup-3.0.1.32.exe"
ShowInstDetails show
LoadLanguageFile "${NSISDIR}\Contrib\Language files\English.nlf"

; Version Information
VIProductVersion "3.0.1.32"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "3.0.1.32"
...
Section "Main"
  ...
  File /r ..\octgnFX\OCTGN\bin\Release-Test\*.*
SectionEnd
